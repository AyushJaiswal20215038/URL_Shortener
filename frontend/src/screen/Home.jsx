    ...
    <div className="homepage">
      ...
      <section className="image-section">
        <div className="image-item">
          <p>
            Welcome to our powerful and easy-to-use URL shortener tool! Whether
            you're sharing links on social media, in emails, or for business
            purposes, our service ensures that your long URLs become compact,
            memorable, and easy to manage.
          </p>
        </div>
      </section>
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            hidden fees. Our tool is fast, efficient, and free for basic usage.
          </li>
        </ul>
      </section>
